...
namespace vgui
{
	...
	public:
		...
		virtual void Keep(IPanel* vguiPanel, int state) = 0;
		virtual void Keep1(IPanel* vguiPanel) = 0;
		virtual void Keep2(IPanel* vguiPanel) = 0;
		virtual void Keep3(IPanel* vguiPanel, int state) = 0;
		virtual void Keep4(IPanel* vguiPanel) = 0;
