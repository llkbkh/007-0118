...
{
	//int			(*pfnUnkon_1)				(char* s);
	//int			(*pfnUnkon_2)				(char* s);
	...
	void		(*pfnUn031801)		(int a1, int a2, float a3, float a4);	//2021-05-27 22:12:49 添加
	...
	void		(*pfnWriteLongI)			(int iValue,int iValue2);	//2020-05-08 03:09:36  新添加的函数
	void		(*pfnWriteFloat)			(float flValue);			//新添加的函数
	...
	ULONG*		GetSharedDataMgr();					//#CSO_LobyDisconnect_MSG
...
typedef struct 
{
	...
	//---------------------
	void			(*pfn_unknown_1)		(edict_t *pEntity);
