...
void QVector::AngleMatrix ( QAngle& Rotation, float ( *matrix )[3] )
{
...
void QVector::VectorRotate ( QVector& In,QAngle& Rotation )
{
	float matRotate[3][3];
...
QAngle QVector::ToEulerAngles ( QVector* PseudoUp )
{
	QVector Left;
